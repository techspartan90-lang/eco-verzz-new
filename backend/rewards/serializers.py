...
class RewardChestSerializer(serializers.ModelSerializer):
    class Meta:
        model = RewardChest
        fields = "__all__"
        read_only_fields = ["id", "user", "is_opened",
                            "points_reward", "xp_reward", "created_at"]
...
class UserBadgeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserBadge
        fields = ["id", "user", "badge", "badge_name",
                  "badge_emoji", "badge_description", "unlocked_at"]
        read_only_fields = ["id", "user", "unlocked_at"]
...
class CouponSerializer(serializers.ModelSerializer):
    class Meta:
        model = Coupon
        fields = ["id", "title", "partner_vendor", "points_cost",
                  "discount_code", "is_redeemed", "created_at"]
